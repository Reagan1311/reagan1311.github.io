...
<div class="row justify-content-center">
  <div class="text-center">
      <a href="https://arxiv.org/abs/2104.01893" target="_blank" class="btn btn-sm rounded-pill" role="button" style="background-color: #282828; color: white; margin: 5px; padding: 6px 16px; text-transform: none; font-size: 14px; box-shadow: none !important; outline: none !important;">
        <i class="fas fa-file-pdf"></i> Paper
      </a>
      <a href="/assets/pdf/ASGNet_supp.pdf" target="_blank" class="btn btn-sm rounded-pill" role="button" style="background-color: #282828; color: white; margin: 5px; padding: 6px 16px; text-transform: none; font-size: 14px; box-shadow: none !important; outline: none !important;">
        <i class="fas fa-file-pdf"></i> Supp
      </a>
      <a href="https://github.com/Reagan1311/ASGNet" target="_blank" class="btn btn-sm rounded-pill" role="button" style="background-color: #282828; color: white; margin: 5px; padding: 6px 16px; text-transform: none; font-size: 14px; box-shadow: none !important; outline: none !important;">
        <i class="fab fa-github"></i> Code
      </a>
      <a href="https://www.youtube.com/watch?v=6TVfnLLRSZQ&ab_channel=GenLi" target="_blank" class="btn btn-sm rounded-pill" role="button" style="background-color: #282828; color: white; margin: 5px; padding: 6px 16px; text-transform: none; font-size: 14px; box-shadow: none !important; outline: none !important;">
